...
python mysqlbinlog_back.py --host=172.28.85.43  --username=test --port=3311 --password=test --schema=mljr  --table=moshan,t_1 -S mysql-bin.000036 --binlog_start_time='2019-09-27 11:31:40' --skip_insert --skip_update -l tmp_sql #多表用逗号隔开
